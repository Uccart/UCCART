...
CREATE TABLE IF NOT EXISTS personas (
  ...
  personas_fecha_de_nacimiento DATE,
...
CREATE TABLE IF NOT EXISTS contrasenas (
    ...
    FOREIGN KEY (cont_idestudiante) REFERENCES estudiante(personas_id)
);
...
CREATE TABLE IF NOT EXISTS beca (
    ...
    FOREIGN KEY (beca_idestudiante) REFERENCES estudiante(personas_id)
);
...
CREATE TABLE IF NOT EXISTS padron (
    ...
    FOREIGN KEY (pad_idestudiante) REFERENCES estudiante(personas_id)
);
...
CREATE TABLE IF NOT EXISTS curso (
    ...
    FOREIGN KEY (curso_codprofesor) REFERENCES profesor(personas_id),
...
CREATE TABLE IF NOT EXISTS nota (
    ...
    FOREIGN KEY (nota_codestudiante) REFERENCES estudiante(personas_id)
);
