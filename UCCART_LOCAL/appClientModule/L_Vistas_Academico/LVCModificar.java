...
public final class LVCModificar extends JDialog implements ActionListener {
	...
	public LVCModificar(JFrame padre, boolean modal, Font f){
		super(padre, modal);
		fo = f;
		bcurso = new B_Curso();
	...
	public void init(){
      ...
      //<editor-fold defaultstate="collapsed" desc=" Layout ">
        ...
        jLabel14.setFont(fo);
        JLabel jLabel15 = new JLabel("Fecha de finalizaci�n:");
        jLabel15.setFont(fo);
				...
				if(!("".equals(jtfsigla.getText()) ) && !("".equals(jtfmaximo.getText()))&& !("".equals(jtfminimo.getText()))){
					if(bcurso.validapk(jtfsigla.getText())){
						if(Integer.parseInt(jtfminimo.getText())<=Integer.parseInt(jtfmaximo.getText())&& hini<hfin&& this.validarFecha()){
							...
							if(bcurso.insert()){
								JOptionPane.showMessageDialog(null, "Curso "+ jtfsigla.getText()+ " ingresada con �xito", "INFO", JOptionPane.INFORMATION_MESSAGE);
								jtfsigla.setText("");
								jtfaula.setText("");
								jtfsede.setText("");
								jtfminimo.setText("");
