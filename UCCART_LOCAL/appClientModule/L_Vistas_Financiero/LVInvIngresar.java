...
public class LVInvIngresar extends JDialog implements ActionListener {
	...
	public LVInvIngresar(Frame padre, boolean modal, Font f) {
		super(padre, modal);
	...
	public void init(){
		...
		jbagregar.setToolTipText("Agregar nuevo articulo al inventario!");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == this.jbagregar){
			if(!("".equals(jtfid.getText())) && !("".equals(jtfnombre.getText())) && !("".equals(jtfmarca.getText())) && !("".equals(jtfvalor.getText()))  && !("".equals(jtfcantidad.getText()))  && !("".equals(jtfproveedor.getText()))){
				if(binventario.validapk(jtfid.getText())){
