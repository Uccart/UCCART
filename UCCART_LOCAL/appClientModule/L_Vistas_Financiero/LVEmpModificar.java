...
public class LVEmpModificar extends JDialog implements ActionListener {
	private Font fo;
	...
	public LVEmpModificar(JFrame padre, boolean modal, Font f){
		super(padre, modal);
		fo = f;
		estado = true;
	...
	public void init(B_Empleado best){
		
		bempleado = best;
		JPanel panel2 = new JPanel();
		panel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Modificar Empleado"));
		...
		jtfid.setFont(fo);
		jtfid.setText(bempleado.getEmpleado().getEmpleadoId().toString());
		...
		jbModificar.setToolTipText("Modificar nuevo empleado!");
		...
		if(e.getSource() == this.jbModificar){
			if(!("".equals(jtfid.getText())) && !("".equals(jtfnombre.getText())) && !("".equals(jtfapellido1.getText())) && !("".equals(jtfapellido2.getText()))  
				...
				if(jtfid.getText() != " "){
					...
					if(bempleado.update(jtfid.getText(), jtfnombre.getText(), jtfapellido1.getText(), jtfapellido2.getText(), jcbnacimiento.getTargetDate(), 
							jtftelefono.getText() , jtfcelular.getText() , jtadireccion.getText() , jcbgenero.getSelectedItem().toString() , jtfnacionalidad.getText(), 
							jtfemail.getText(), Integer.parseInt(jtfSalario.getText()) , jtfpuesto.getText())){
				...
				if(!("".equals(jtfid.getText())) && !("".equals(jtfnombre.getText())) && !("".equals(jtfapellido1.getText())) && !("".equals(jtfapellido2.getText()))  
					...
					JOptionPane.showMessageDialog(null, "Error al Modificar el Empleado, datos incorrectos ", "Error", JOptionPane.ERROR_MESSAGE);
